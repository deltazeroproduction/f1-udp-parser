...
export const TEAMS: {[index: number]: Team} = {
  ...
  117: {name: 'Prema 22', color: PREMA_COLOR},
  118: {name: 'Virtuosi 22', color: UNI_VIRTUOSI_COLOR},
  119: {name: 'Carlin 22', color: CARLIN_COLOR},
  120: {name: 'HiTech 22', color: HITECH_COLOR},
  121: {name: 'ART GP 22', color: ART_GRAND_PRIX_COLOR},
  122: {name: 'MP Motorsport 22', color: MP_MOTORSPORT_COLOR},
  123: {name: 'Charouz 22', color: CHAROUZ_COLOR},
  124: {name: 'Dams 22', color: DAMS_COLOR},
  125: {name: 'Campos 22', color: CAMPOS_VEXATEC_COLOR},
  126: {name: 'Van Amersfoort Racing 22', color: BWT_ARDEN_COLOR},
  127: {name: 'Trident 22', color: TRIDENT_COLOR},
  128: {name: 'Mercedes AMG GT Black Series', color: MERCEDES_COLOR},
